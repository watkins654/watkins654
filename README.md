...
React · Next.js · Remix · Tailwind
Node.js · Supabase (Postgres) · row-level security · REST APIs · idempotent webhooks · OAuth 2.0 · Stripe
LLM integration (Claude) · tool use · MCP · RAG · structured output · prompt &amp; context engineering
Background jobs · Web Push · PWAs · Vercel · Cloudflare · Oracle Cloud · Docker · GitHub Actions

### How I build

A multi-agent dev loop: Claude Code, Codex CLI, and Gemini CLI in tmux, for parallel feature work, test generation, and refactoring.

### Reach me

Portfolio: [braydenwatkins.dev](https://braydenwatkins.dev) · Open to remote US roles with agencies, dev shops, and in-house product teams.
